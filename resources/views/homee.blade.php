...
<div class="row g-0">
    <div class="col-md-2 d-flex flex-column  p-3 text-white bg-success " style="width: 222px; height: 100vh;  ">
 ...
 <ul class="nav nav-pills flex-column mb-auto ">
    ...
    <li class="nav-item">   
        <a href="homee" class="nav-link active text-white"><i class="bi bi-house-door me-2"></i>Home</a>
    </li>
    <li class="nav-item">
        <a href="mp" class="nav-link  text-white"><i class="bi bi-hdd me-2"></i>master project</a>
    </li>
    <li class="nav-item">
            ...
            <div class="col-md-8 padding-bottom-5">
                <div class="card shadow">
                    <div class="card-header">
                        <h6>DATA SERVICE and DATA PROJECT</h6>
                    </div>
                    <div class="card-body ">
